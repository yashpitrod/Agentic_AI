...
- God classes: any class with 200+ lines or 10+ methods
- functions with 50+ lines
- circular imports visible from the diff
- clear SRP violations, such as one class handling database and email behavior
